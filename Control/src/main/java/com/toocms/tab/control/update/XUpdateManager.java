...
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.CHECK_NO_NETWORK;
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.CHECK_NO_NEW_VERSION;
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.CHECK_NO_WIFI;
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.PROMPT_ACTIVITY_DESTROY;
 ...
 */
public class XUpdateManager implements IUpdateProxy {
    /**
     * 版本更新代理
     */
     ...
     * @param builder
     */
    private XUpdateManager(Builder builder) {
     ...
     * @return
     */
    public XUpdateManager setIUpdateProxy(IUpdateProxy updateProxy) {
