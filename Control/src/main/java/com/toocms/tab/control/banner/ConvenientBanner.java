package com.toocms.tab.control.banner;
...
import com.toocms.tab.control.banner.adapter.CBPageAdapter;
import com.toocms.tab.control.banner.helper.CBLoopScaleHelper;
import com.toocms.tab.control.banner.holder.CBViewHolderCreator;
import com.toocms.tab.control.banner.listener.CBPageChangeListener;
...
import com.toocms.tab.control.banner.view.CBLoopViewPager;
