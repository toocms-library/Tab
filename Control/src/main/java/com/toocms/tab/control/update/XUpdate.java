...
import com.toocms.tab.control.update.listener.OnInstallListener;
import com.toocms.tab.control.update.listener.OnUpdateFailureListener;
import com.toocms.tab.control.update.listener.impl.DefaultInstallListener;
import com.toocms.tab.control.update.listener.impl.DefaultUpdateFailureListener;
import com.toocms.tab.control.update.logs.ILogger;
import com.toocms.tab.control.update.logs.UpdateLog;
import com.toocms.tab.control.update.proxy.IFileEncryptor;
import com.toocms.tab.control.update.proxy.IUpdateChecker;
...
import com.toocms.tab.control.update.proxy.impl.DefaultUpdateChecker;
import com.toocms.tab.control.update.proxy.impl.DefaultUpdateDownloader;
import com.toocms.tab.control.update.proxy.impl.DefaultUpdateParser;
import com.toocms.tab.control.update.proxy.impl.DefaultUpdatePrompter;
...
public class XUpdate {
     ...
     * @return
     */
    public static XUpdateManager.Builder newBuild(@NonNull Context context) {
        return new XUpdateManager.Builder(context);
    }
     ...
     * @return
     */
    public static XUpdateManager.Builder newBuild(@NonNull Context context, String updateUrl) {
        return new XUpdateManager.Builder(context)
                .updateUrl(updateUrl);
    }
