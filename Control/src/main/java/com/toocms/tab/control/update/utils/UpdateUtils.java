...
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.CHECK_APK_CACHE_DIR_EMPTY;
import static com.toocms.tab.control.update.entity.UpdateError.ERROR.CHECK_IGNORED_VERSION;
