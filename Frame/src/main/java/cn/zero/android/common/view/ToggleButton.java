...
public class ToggleButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.ToggleButton);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.ToggleButton_tb_shadow_effect,
                true);

        uncheckCircleColor = optColor(typedArray,
                R.styleable.ToggleButton_tb_uncheckcircle_color,
                0XffAAAAAA);//0XffAAAAAA;

        uncheckCircleWidth = optPixelSize(typedArray,
                R.styleable.ToggleButton_tb_uncheckcircle_width,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.ToggleButton_tb_uncheckcircle_radius,
                dp2px(4));//dp2px(4);
