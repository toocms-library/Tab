...
public class SlidingLayer extends FrameLayout {
    ...
    /**
     * Special value for the position of the layer. STICK_TO_RIGHT means that the view shall be attached to the right side of the screen, and come from there into the viewable area.
     */
    public static final int STICK_TO_RIGHT = -1;

    /**
     * Special value for the position of the layer. STICK_TO_LEFT means that the view shall be attached to the left side of the screen, and come from there into the viewable area.
     */
    public static final int STICK_TO_LEFT = -2;

    /**
     * Special value for the position of the layer. STICK_TO_MIDDLE means that the view will stay attached trying to be in the middle of the screen and allowing dismissing both to right and left side.
     */
    ...
    public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
        ...
        // Set the side of the screen 从哪个方向隐藏和显示菜单，默认是从右边显示
    ...
    /**
     * Sets the shadow of the width which will be included within the view by using padding since it's on the left of the view in this case
     *
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        mLastTouchAllowed = !(action == MotionEvent.ACTION_UP || action == MotionEvent.ACTION_CANCEL || action == MotionEvent.ACTION_OUTSIDE);
