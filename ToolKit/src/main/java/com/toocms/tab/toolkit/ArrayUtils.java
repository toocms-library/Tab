...
//        }
     ...
     * <li>if target element exist in array and its index is 0, return the last one in array if isCircle is true, else return defaultValue</li>
     * </ul>
     *
     * @param <V>
     * @param sourceArray
    ...
    public static int getMax(int[] sourceArray) {
        if (sourceArray.length == 0) {
            throw new IllegalArgumentException("The length of source array must be greater than 0.");
        }
