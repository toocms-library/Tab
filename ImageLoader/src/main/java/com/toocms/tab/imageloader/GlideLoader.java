...
import com.toocms.tab.imageloader.progress.OnProgressListener;
import com.toocms.tab.imageloader.progress.ProgressManager;
...
public class GlideLoader {
    ...
    public GlideLoader load(@DrawableRes int resId, @DrawableRes int placeholder, @NonNull Transformation<Bitmap> transformation) {
