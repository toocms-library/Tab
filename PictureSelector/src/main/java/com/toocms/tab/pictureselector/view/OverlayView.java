...
import com.toocms.tab.pictureselector.callback.OverlayViewChangeListener;
import com.toocms.tab.pictureselector.util.RectUtils;

/**
 * Created by Oleksii Shliama (https://github.com/shliama).
 * <p/>
 * This view is used for drawing the overlay on top of the image. It may have tab, crop guidelines and dimmed area.
...
public class OverlayView extends View {
     ...
     *
     * @param showCropFrame - set to true if you want to see a crop tab rectangle on top of an image
     */
    ...
    /**
     * Setter for crop tab stroke width
     */
