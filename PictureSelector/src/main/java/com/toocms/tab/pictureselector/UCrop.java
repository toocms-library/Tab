...
public class UCrop {
    ...
    public static class Options {
        ...
        /**
         * @param show - set to true if you want to see a crop tab rectangle on top of an image
         */
        ...
        /**
         * @param color - desired color of crop tab
         */
        ...
        /**
         * @param width - desired width of crop tab line in pixels
         */
